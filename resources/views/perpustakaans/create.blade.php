            ...
            <div class="card">
                <div class="card-body" style="overflow: auto">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td><label for="LabelNama">Nama Perpustakaan</label></td>
                            <td><input type="text" size="70" id="InputNama" placeholder="Nama Perpustakaan" name="namaperpustakaan"></td>
                        </tr>
                        <tr>
                            <td><label for="LabelAlamat">Alamat Perpustakaan</label></td>
                            <td><input type="text" size="70" id="InputAlamat" placeholder="Alamat" name="alamat"></td>
                        </tr>
                        <tr>
                            <td><label for="LabelJam">Jam Operasional</label></td>
                            <td><input type="text" size="70" id="InputJam" placeholder="Jam" name="jam"></td>
                        </tr>
                        <tr>
