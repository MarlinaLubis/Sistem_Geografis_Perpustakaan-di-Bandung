...
<head>
    ...
    <title>Perpustakaan Di Bandung</title>
    ...
    <style>
        ...
        a {
            ...
            color: #fff;
            /* Adjust link color based on your background */
            text-decoration: underline;
            font-weight: 600;
            font-size: 1.125rem;
            /* Match the font size with the main content */
            margin-left: 1rem;
            /* Adjust spacing */
        }
...
<body>
    ...
    <div>
        <h1>Welcome to Perpustakaan in Bandung</h1>
        <div class="card">
